class ContentFilter {
  ...
  static bool containsBlockedContent(String text) {
    ...
    for (final word in bannedWords) {
      ...
      if (_containsWholePhrase(normalizedText, normalizedWord)) {
        return true;
      }
    }
  ...
  static String? validateCleanText(
      String? value, {
        required String emptyMessage,
        String blockedMessage = 'Please remove inappropriate language.',
      }) {
  ...
  static String? validateOptionalCleanText(
      String? value, {
        String blockedMessage = 'Please remove inappropriate language.',
      }) {
    if (value == null || value.trim().isEmpty) {
